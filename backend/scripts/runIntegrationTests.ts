...
const env: NodeJS.ProcessEnv = {
  ...
  API_TOKEN_USER_ID: process.env.API_TOKEN_USER_ID ?? "integration-user",
  SESSION_SECRET: process.env.SESSION_SECRET ?? "t".repeat(32),
  APPLE_BUNDLE_ID: process.env.APPLE_BUNDLE_ID ?? "com.readinesscoach.app",
  LLM_API_KEY: "",
